...
import RedeemCard from "@/widgets/RedeemCard.vue";
import RedeemCodeManageCard from "@/widgets/RedeemCodeManageCard.vue";
import PlanManageCard from "@/widgets/PlanManageCard.vue";
import MailConfigCard from "@/widgets/MailConfigCard.vue";
...
export function getLayoutCardPool() {
  const LAYOUT_CARD_POOL: NewCardItem[] = [
...

    {
      ...
      title: "邮箱注册配置",
      width: 6,
      description: "配置 SMTP 邮件发送，开启邮箱注册功能",
      height: LayoutCardHeight.AUTO,
      category: NEW_CARD_TYPE.MANAGE
    },
    {
      id: getRandomId(),
      permission: ROLE.ADMIN,
      meta: {},
      type: "RedeemCodeManageCard",
      title: "兑换码管理",
      width: 8,
      description: "生成、查看、删除兑换码",
      height: LayoutCardHeight.AUTO,
      category: NEW_CARD_TYPE.MANAGE
    },
    {
      ...
      title: "套餐管理",
      width: 8,
      description: "管理实例套餐模板：镜像、资源、时长等",
      height: LayoutCardHeight.AUTO,
      category: NEW_CARD_TYPE.MANAGE
    },
